...
ground_guideline = {
    "지원 동기": [
        "지원한 회사와 직무에 대한 당신의 열정과 흥미를 구체적인 예시를 들어 서술해 주세요.",
        "당신이 이 직무에 적합한 이유와 관련 경험을 강조하여 서술해 주세요.",
        "이 회사를 선택한 구체적인 이유와 그것이 당신의 장기적인 경력 목표와 어떻게 연결되는지 설명해 주세요.",
        "해당 직무나 업계에서 당신이 기여할 수 있는 독특한 점이나 스킬을 강조하여 서술해 주세요.",
        "회사의 미션, 비전, 가치와 당신의 가치관이 어떻게 일치하는지 예시를 들어 서술해 주세요.",
    ],
    "직무 관심 계기": [
